...
class EventId(RootModel[constr(pattern=r'^EVENT-[A-Za-z0-9][A-Za-z0-9._-]*$')]):
    root: constr(pattern=r'^EVENT-[A-Za-z0-9][A-Za-z0-9._-]*$')
...
class TransactionJournalV1(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
