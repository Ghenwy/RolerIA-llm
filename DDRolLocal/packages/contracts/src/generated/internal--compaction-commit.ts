/* GENERATED FILE - DO NOT EDIT. source=internal/compaction-commit.schema.json schema_sha256=31c44e2d1ffa0cdd85b2b26e055c3a85d0d81544c75fed22de2b24895a826cbf */

/**
 * This interface was referenced by `CompactionCommitV1`'s JSON-Schema
 * via the `definition` "stringSet".
 */
export type StringSet = string[];

export interface CompactionCommitV1 {
  schema_version: '1.0';
  commit_id: string;
  sequence: number;
  proposal_id: string;
...
export interface ValidationManifest {
  ...
  target_min_input_tokens: 52000;
  target_max_input_tokens: 62000;
}
/**
 * This interface was referenced by `CompactionCommitV1`'s JSON-Schema
